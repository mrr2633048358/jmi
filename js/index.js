window.onload=function(){
	...
	$('.nav-center').hover(function(){
		$('.nav-items').css({height:'390px'});
		$('.nav-center li').hover(function(){
			$('.nav-item').eq($(this).index()).css({display:'block',zIndex:10});
		},function(){
			$('.nav-item').eq($(this).index()).css({display:'none',zIndex:0});
		})
	},function(){
		$('.nav-items').css({height:'100px'});
	})/*
    ...
    $('.header-gou').hover(function(){
		$('.gouitem').css({height:'100px'});
    },function(){
        $('.gouitem').css({height:'0px'});
    })
